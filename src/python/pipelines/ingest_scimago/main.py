...
Iterates over a scimago CSV file and adds it to the DB.
...
from pipelines.ingest_scimago.ingest_scimago import run_ingest_scimago_pipeline

PIPELINE_NAME = "ingest-scimago"
