"""
Iterates over title embedding feature records and writes embeddings to base
...
from pipelines.records.update_elasticsearch_with_title_embeddings.pipeline import run_pipeline

PIPELINE_NAME = "update-elasticsearch-with-title-embeddings"
