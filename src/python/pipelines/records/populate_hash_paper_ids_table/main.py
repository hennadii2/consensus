"""
Iterates over the full paper dataset and writes hash_paper_id mappings to the DB.
"""
import argparse
import logging
...
from pipelines.records.populate_hash_paper_ids_table.pipeline import run_pipeline

PIPELINE_NAME = "populate-hash-paper-ids-tables"
