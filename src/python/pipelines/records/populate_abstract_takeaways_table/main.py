"""
Iterates over generated paper abstract takeaways and writes them to the DB.
"""
import argparse
import logging
...
from pipelines.records.populate_abstract_takeaways_table.pipeline import run_pipeline

PIPELINE_NAME = "populate-abstract-takeaways-tables"
