...
Iterates over all ingested papers in our DB, looks up the raw abstract text,
cleans the text and writes to blob store and updates references in the DB.
...
from pipelines.text_cleaning.text_cleaning import run_text_cleaning_pipeline

PIPELINE_NAME = "text-cleaning"
