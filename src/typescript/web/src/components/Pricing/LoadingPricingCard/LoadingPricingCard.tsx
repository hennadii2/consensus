...
export default function LoadingPricingCard() {
  return (
    <div data-testid="loadingpricingcard" className="">
      <Card className="mt-0">
        <div className="animate-pulse">
          <div className="flex space-x-10">
            <div className="flex-1">
              ...
              <div className="bg-loading-200 h-3 w-[55%] rounded-xl mb-4" />
              <div className="bg-loading-200 h-3 w-[60%] rounded-xl mb-4" />
              <div className="bg-loading-200 h-3 w-[65%] rounded-xl mb-4" />
              <div className="bg-loading-200 h-3 w-[70%] rounded-xl mb-4" />
              <div className="bg-loading-200 h-3 w-[75%] rounded-xl mb-4" />
              <div className="bg-loading-200 h-3 w-[80%] rounded-xl mb-4" />
              <div className="bg-loading-200 h-3 w-[85%] rounded-xl mb-4" />
